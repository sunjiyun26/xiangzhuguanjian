...
public class GoodsManagerJPanel implements ActionListener, MouseListener {
	...
	public void initSearchPanel() {
		...
		// 标签
		label_category = new JLabel("项目种类");
			...
			if (row < 0) {
				...
				if (result == 0) {
					...
					try {
						...
						if (tempresult > 0) {
							JOptionPane.showMessageDialog(null, "项目删除成功！");
							refreshTablePanel();
						}
					} catch (Exception e1) {
						e1.printStackTrace();
