...
import org.rancode.framework.util.WindowOpacity;
...
public class IndexJFrame extends JFrame implements MouseListener, ActionListener {
	...
	public void initTopMenu() {
		...
		String[] nameStrings = { "首页", "项目管理", "外购货物（材料）管理", "客户管理" };
	...
	// 创建项目管理面板
	public void creatProjectDataTab() {
		...
		jTabbedPane.addTab("项目管理", new GoodsManagerJPanel().backgroundPanel);
	...
	public void mouseClicked(MouseEvent e) {
		if (e.getSource() == home) {
			...
			creatHome();
			home.setText("<html><font color='#336699' style='font-weight:bold'>" + "首页" + "</font>&nbsp;</html>");
			baseData.setText("<html><font color='black'>" + "项目管理" + "</font>&nbsp;</html>");
			purchase_sale_stock.setText("<html><font color='black'>" + "外购货物（材料）管理" + "</font>&nbsp;</html>");
			userManager.setText("<html><font color='black'>" + "用户管理" + "</font>&nbsp;</html>");
		} else if (e.getSource() == baseData) {
			initSign();
			sign_baseData = 1;
			creatProjectDataTab();
			baseData.setText("<html><font color='#336699' style='font-weight:bold'>" + "项目管理" + "</font>&nbsp;</html>");
			...
			purchase_sale_stock.setText(
					"<html><font color='#336699' style='font-weight:bold'>" + "外购货物（材料）管理" + "</font>&nbsp;</html>");
			home.setText("<html><font color='black'>" + "首页" + "</font>&nbsp;</html>");
			baseData.setText("<html><font color='black'>" + "项目管理" + "</font>&nbsp;</html>");
			userManager.setText("<html><font color='black'>" + "用户管理" + "</font>&nbsp;</html>");
